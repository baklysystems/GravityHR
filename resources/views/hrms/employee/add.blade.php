                            ...
                            <div class="wizard steps-bg steps-left">
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="date_of_birth" class="gui-input fs13" name="date_of_birth"
                                                       value="@if($emps && $emps->employee->date_of_birth){{$emps->employee->date_of_birth}}@endif" required>
                                            @else
                                                <input type="text" id="date_of_birth" class="gui-input fs13" name="date_of_birth" required>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="option-group field">
                                            ...
                                            <label class="field option mb5">
                                                ...
                                                <span class="radio"></span>Resigned</label>
                                            @else
                                                <input type="radio" name="status" id="status" value="1">
                                                <span class="radio"></span>Active</label>
                                                <label class="field option mb5">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="date_of_joining" class="gui-input fs13" name="date_of_joining"
                                                       value="@if($emps && $emps->employee->date_of_joining){{$emps->employee->date_of_joining}}@endif" required>
                                            @else
                                                <input type="text" id="date_of_joining" class="gui-input fs13" name="date_of_joining" required>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="job_title" class="gui-input fs13" name="job_title"
                                                       value="@if($emps && $emps->employee->job_title){{$emps->employee->job_title}}@endif" required>
                                            @else
                                                <input type="text" id="job_title" class="gui-input fs13" name="job_title" required>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="sss_number" class="gui-input fs13" name="sss_number"
                                                       value="@if($emps && $emps->employee->sss_number){{$emps->employee->sss_number}}@endif"/>
                                            @else
                                                <input type="text" id="sss_number" class="gui-input fs13" name="sss_number"/>
                                            @endif
                                        </div>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="pagibig_number" class="gui-input fs13" name="pagibig_number"
                                                       value="@if($emps && $emps->employee->pagibig_number){{$emps->employee->pagibig_number}}@endif"/>
                                            @else
                                                <input type="text" id="pagibig_number" class="gui-input fs13" name="pagibig_number"/>
                                            @endif
                                        </div>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="tin_number" class="gui-input fs13" name="tin_number"
                                                       value="@if($emps && $emps->employee->tin_number){{$emps->employee->tin_number}}@endif"/>
                                            @else
                                                <input type="text" id="tin_number" class="gui-input fs13" name="tin_number"/>
                                            @endif
                                        </div>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="philhealth_number" class="gui-input fs13" name="philhealth_number"
                                                       value="@if($emps && $emps->employee->philhealth_number){{$emps->employee->philhealth_number}}@endif"/>
                                            @else
                                                <input type="text" id="philhealth_number" class="gui-input fs13" name="philhealth_number"/>
                                            @endif
                                        </div>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="health_insurance_number" class="gui-input fs13" name="health_insurance_number"
                                                       value="@if($emps && $emps->employee->health_insurance_number){{$emps->employee->health_insurance_number}}@endif"/>
                                            @else
                                                <input type="text" id="health_insurance_number" class="gui-input fs13" name="health_insurance_number"/>
                                            @endif
                                        </div>

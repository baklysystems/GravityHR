		...
		<div class="chute-bin1 stretch1 btn-dimmer mt20">
				...
				<div class="tab-content pn br-n bg-none allcp-form-list">
					...
					<ul class="nav list-unstyled" role="tablist">
						...
						<li>
							<a class="btn btn-primary btn-gradient btn-alt btn-block item-active br-n" href="#login" role="tab" data-toggle="tab"> Upload Holiday Sheet </a>
						</li>

						<li>
							<a class="btn btn-danger btn-gradient btn-alt btn-block br-n" href="#register" role="tab" data-toggle="tab"> See Uploaded Sheets </a>
						</li>
					</ul>
				</div>
			</div> 
		...
		<div class="chute chute-center">
			<div class="">
				...
				<div class="tab-content mw900 center-block center-children">
					...
					<div class="allcp-form theme-primary tab-pane active mw320" id="login" role="tabpanel">
						<div class="box box-success">
							<div class="panel fluid-width">
								...
								@endif {!! Form::open(['class' => 'form-horizontal', 'files' => true]) !!}
								<div class="panel-body pn mv12">
									<!-- -------------- /section -------------- -->

									<div class="section">
										<label for="username" class="field prepend-icon"> <h6 > Description </h6> </label>
										<input type="text" class="gui-input" name="description" placeholder="Description" required>
									</div>
					...
					<!-- -------------- Registration -------------- -->
					<div class="allcp-form theme-primary tab-pane mw900" id="register" role="tabpanel">
						<div class="box box-success">
							<div class="panel">
								...
								<div class="panel-body table-responsive">
									<div class="form-horizontal">
										<table class="table table-bordered table-hover">
											...
											<tbody>
												<?php $i =0;?> @foreach($filenames as $holiday)
